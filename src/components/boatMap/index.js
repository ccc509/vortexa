...
function BoatMap() {
    ...
    var rampsInTheMap = react_redux_1.useSelector(function (state) { return state.rampsInTheMap; });
    var getCentreOfView = function () {
        var latitudes = [];
        var longitudes = [];
        rampsInTheMap.features.forEach(function (feature) {
    ...
    return (react_1.default.createElement(react_leaflet_1.Map, { onzoomend: handleZooming, center: getCentreOfView(), zoom: 10 },
        ...
        react_1.default.createElement(react_leaflet_1.GeoJSON, { key: object_hash_1.default(rampsInTheMap), data: rampsInTheMap })));
}
