...
var BoatMap = function () {
    ...
    return (react_1.default.createElement(react_leaflet_1.Map, { onzoomend: function (e) { return dispatch(boatMapActions_1.zoomMap(e.target.getBounds())); }, center: center, zoom: 10, className: boatMap },
